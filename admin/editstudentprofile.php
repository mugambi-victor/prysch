...
if (isset($_REQUEST['save'])) {
  ...
  echo '<script>setTimeout(function(){
    ...
    ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sname" value="<?php echo $result['s_name'] ?>"
                            name="sname" required>
                    </div>
                    <div class="col-md-6">
                        <label for="dob" class="form-label">DOB</label>
                        <input type="text" class="form-control" id="dob" value="<?php echo $result['dob'] ?>"
                            name="dob">
                        <input type="text" class="form-control" id="regno" value="<?php echo $result['regno'] ?>"
                            name="regno" hidden>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="yoj" value="<?php echo $result['year'] ?>"
                            name="yoj" required>
                    </div>
      ...
      ?>
                                <option selected value="<?php echo $academicid ?>"><?php echo $aresult['sname'] ?>
                                </option>
                                <?php
    ...
    ?>
                            <input type="text" class="form-control" id="class" value="<?php echo "$cid"; ?>" hidden
                                name="class" required>
                            <input type="text" class="form-control" id="class1" value="<?php echo "$classname"; ?>"
                                name="class1" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="pname"
                                value="<?php echo $result['parent_name'] ?>" name="pname" required>
                        </div>
                        <div class="col-md-6">
                            <label for="pemail" class="form-label">Parent/Guardian Email</label>
                            <input type="email" class="form-control" id="pemail" value="<?php echo $result['email'] ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="pno" value="<?php echo $result['pno'] ?>"
                                name="pno" required>
                        </div>
