...
<!-- <div class="header">
        ...
        <a class="active" href="">Home</a>
            <a href="t_login.php">Employee Login</a>
        </div>
...
$res = mysqli_query($conn,"select* from teacher where email='$a'and password='$b'");
$result=mysqli_fetch_array($res);
if($result)
{
	
	$_SESSION["emp_login"]="$a";
   ...
   echo("error") ;
    ...
    <div class="container" style="border:0; margin-top:40px;">
        <form class="needs-validation" style=" margin:auto;  width:40%; " action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); 
            ?>" method="post">
          <center>  <div class="iccon" style="padding:10px;"><img src="../images/teacher.jfif" alt="" width="100" height="80"></div>
        <h2>Teacher's Login Page</h2></center>
